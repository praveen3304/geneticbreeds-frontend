...
export default function Landing({ onLogin, onRegister }) {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: isMobile ? "column" : "row", overflow: "hidden" }}>
      <div style={{ flex: 1, background: "#ffffff", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: isMobile ? "16px 20px" : "60px 40px", position: "relative", overflow: "hidden" }}>
        <div style={{ position: "absolute", fontSize: "220px", opacity: 0.04, bottom: "-30px", left: "-20px", userSelect: "none" }}>🐾</div>
        <p style={{ margin: "0 0 10px", fontSize: isMobile ? "13px" : "16px", fontWeight: "850", letterSpacing: "2px", textTransform: "uppercase", background: "linear-gradient(135deg, #b91c1c 0%, #7c3aed 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", fontFamily: "Georgia, serif", textAlign: "center" }}>The World's Most Trusted Pet Marketplace.</p>
        
        <img src={logo} alt="Genetic Breeds" style={{ width: "min(360px, 70vw)", height: "auto", marginBottom: "4px", filter: "drop-shadow(0 12px 32px rgba(185,28,28,0.15)) contrast(1.04) saturate(1.1)" }} />
        <p style={{ color: "#383847", fontSize: isMobile ? "13px" : "15px", fontWeight: "600", textAlign: "center", lineHeight: 1.7, maxWidth: "380px", fontFamily: "serif", margin: "0 0 12px" }}>Connecting Pet Lovers with Verified Breeders for Rare, Exotic & Purebreed Animals Across the Globe.</p>
      ...
      <div style={{ flex: isMobile ? "unset" : "0 0 420px", background: "#ffffff", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: isMobile ? "16px 20px" : "60px 48px" }}>
        <div style={{ width: "100%", maxWidth: "340px" }}>
          <h2 style={{ margin: "0 0 8px", fontSize: "28px", fontWeight: "800", color: "#111827" }}>Welcome Back 👋</h2>
          <p style={{ margin: "0 0 16px", fontSize: "14px", color: "#6b7280" }}>Sign in to your account or create a new one.</p>
