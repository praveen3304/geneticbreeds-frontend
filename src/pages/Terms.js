...
const INDIA_SECTIONS = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        content: `Genetic Breeds acts solely as a neutral intermediary platform. We are not a party to any transaction between buyers and sellers. We do not verify the health, quality, breed accuracy, or legal status of any animal listed.\n\nSellers are solely and legally responsible for ensuring that every animal listed for sale \u2014 including but not limited to dogs \u2014 is microchipped and accompanied by a valid health certificate from a registered veterinary practitioner, as required under the Prevention of Cruelty to Animals (Dog Breeding and Marketing) Rules, 2017 and the Prevention of Cruelty to Animals (Pet Shop) Rules, 2018. Genetic Breeds does not physically inspect, verify, or authenticate any microchip, health certificate, or other documentation provided by a seller, and takes no liability for forged, incomplete, or missing documentation.\n\nGenetic Breeds holds no liability for:\n\u2022 The accuracy or truthfulness of any listing\n\u2022 The health or condition of any animal\n\u2022 Any disputes, losses, or damages arising from user transactions\n\u2022 Any fraudulent or deceptive activity by users\n\u2022 Delivery, transportation, or transfer of animals\n\u2022 Any legal violations committed by users`,
      },
      {
      ...
      },
      {
        ...
        content: `Genetic Breeds strictly prohibits listing, promotion, or sale of:\n\u2022 Any animal breed banned or restricted under Indian law or your state's regulations\n\u2022 Wildlife species protected under the Wildlife Protection Act, 1972\n\u2022 CITES-listed species that are internationally protected\n\u2022 Any animal obtained through poaching, illegal trapping, or wildlife trafficking\n\u2022 Any animal illegal to own, sell, or trade in India\n\u2022 Any animal subjected to inhumane treatment or illegal breeding\n\nUsers are solely responsible for verifying that their listings comply with all applicable laws. Genetic Breeds reserves the exclusive right to instantly remove any listing, suspend or freeze any account, or withhold platform access \u2014 without prior notice, financial liability, or any obligation to refund fees or membership credits \u2014 if a government body, court, or regulatory authority issues an order, advisory, or amendment restricting a specific breed, species, or category of animal. Violations will result in immediate account suspension and may be reported to relevant authorities including the Wildlife Crime Control Bureau (WCCB).`,
      },
      {
      ...
      },
      {
        ...
        content: `Genetic Breeds charges fees for ad posting and membership plans. These fees are solely an administrative charge for online ad-display space, listing visibility, and profile features, and do not constitute a brokerage fee, transaction commission, guarantee of sale, or insurance of any kind for the underlying animal trade. All payments are processed through our secure payment gateway.\n\n\u2022 All fees are displayed in Indian Rupees (INR) for Indian users\n\u2022 Payments are non-refundable once processed, except as outlined in our Refund Policy\n\u2022 Membership credits are non-transferable and expire as per plan terms\n\u2022 We are not responsible for payment disputes between buyers and sellers for animal transactions, and payment of any fee to Genetic Breeds \u2014 including for a verified seller or trust badge \u2014 is not a guarantee, endorsement, or warranty of that seller's conduct, honesty, or legal compliance\n\u2022 We reserve the right to modify our pricing at any time with reasonable notice`,
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        content: `All users of Genetic Breeds must comply with applicable animal welfare and protection laws in India. This includes but is not limited to:\n\u2022 Prevention of Cruelty to Animals Act, 1960\n\u2022 Wildlife Protection Act, 1972\n\u2022 Dog Breeding & Marketing Rules, 2017\n\u2022 Prevention of Cruelty to Animals (Pet Shop) Rules, 2018\n\u2022 State-specific animal welfare, livestock transport, and breeding regulations\n\u2022 Local Municipal Corporation rules for pet shops\n\nSellers listing live animals explicitly warrant that they hold valid registration with their respective State Animal Welfare Board (SAWB) where required by law. Users are solely responsible for ensuring their listings and transactions comply with all applicable laws.`,
      },
      {
